    ...
    return (
        <div className="h-screen max-h-screen min-w-72 bg-sidebarBackground flex flex-col justify-between drop-shadow-xl">
            ...
            <div className="p-2 pb-4 relative overflow-hidden">
                ...
                >
                    <div className={`
                        absolute top-0 left-0 w-full py-5 hover:bg-background flex justify-center transition-all duration-300 rounded-xl cursor-pointer
                    ...
                    <button
                        ...
                        className={`
                            absolute top-0 left-0 w-full py-5 bg-red-500 text-white rounded-xl 
